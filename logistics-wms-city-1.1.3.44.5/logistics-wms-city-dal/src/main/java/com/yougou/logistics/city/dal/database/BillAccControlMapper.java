/*
 * 类名 com.yougou.logistics.city.dal.database.BillAccControlMapper
 * @author su.yq
...
public interface BillAccControlMapper extends BaseCrudMapper {
	 ...
	 * @throws Exception
	 */
	public void procAccApply(Map<String, Object> maps) throws Exception;
	 ...
	 * @throws Exception
	 */
	public void procAccPrepareDataExt(Map<String, Object> maps) throws Exception;
	 ...
	 * @throws Exception
	 */
	public List<BillAccControl> selectBillAccControlGroupByBillName(Map<String, Object> maps) throws DaoException;

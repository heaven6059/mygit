...
<div width='100%' id="${id}" class="easyui-panel" title="${title}" style="padding:0px;background:#F4F4F4" 
     ...
     <@p.datagrid id="queryConditionDiv_dataGrid"  loadUrl="" saveUrl=""  defaultColumn=""  
       ...
       columnsJsonList='[
          ...
          {field : "columnName",title : "字段名称",formatter:columnNameFormatter,width : 150,editor:{type:"combobox", options:{required:true,missingMessage:"必填项不能为空!",panelHeight:"150",url:columnNameURL,valueField:"valueField",textField:"textField"} }  } ,

...
<script type="text/javascript">
   ...
   function getUnAlls(){
      $('#mainDataGrid').datagrid('clearChecked');
   }
...
<body >
		      ...
		      <@p.datagrid id="mainDataGrid"  loadUrl="/stock/list.json" saveUrl=""  defaultColumn=""  
		                   isHasToolBar="false"  divToolbar="#toolbar" height="623"  onClickRowEdit="false" 
		                   singleSelect="false" pageSize="10" idField="stocknum"
			               columnsJsonList="[
			                  {field : 't',checkbox:true,width : 30},
			                  {field : 'stocknum',width : 100},
			 ...
			 <#-- 工具条与查询条件域 -->	
				<div id="toolbar" style="padding:5px;height:auto">
					<div style="margin-bottom:5px">
						...
						<a href="javascript:getAlls();" class="easyui-linkbutton" iconCls="icon-ok" plain="true">获得所有页选择</a>
						<a href="javascript:getUnAlls();" class="easyui-linkbutton" iconCls="icon-cancel" plain="true">取消所有页选择</a>
						<a href="javascript:parent.closeWindow('主从从表操作');" class="easyui-linkbutton" iconCls="icon-no" plain="true">关闭</a>
					</div>
					<div>

...
<script type="text/javascript">
	function upload_(obj){
		...
		if(fileName==""){
			...
			parent.cmdefcell.loading("show","正在解析和验证数据......");
	...
	$(function(){
		...
		var uuId="${uuId}";
		if(result=="success"){
			parent.cmdefcell.loading();
			parent.cmdefcell.importSuccess(uuId);
		}else {
			parent.cmdefcell.loading();
			if(msg != ''){
				parent.alert(msg,2);
...
<body>
	<div id="div_1">
		<form name="fileForm"  id="fileForm" method="post" action="../cmdefcell_import/importExcel" class="city-form" enctype="multipart/form-data">

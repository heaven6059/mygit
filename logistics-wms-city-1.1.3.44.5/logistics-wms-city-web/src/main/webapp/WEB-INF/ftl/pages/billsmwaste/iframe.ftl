...
<script type="text/javascript">
	function upload_(obj){
		...
		if(fileName==""){
			...
			parent.billsmwaste.loading("show","正在导入......");
	...
	$(function(){
		...
		var msg = "${msg}";
		if(result=="success"){
			parent.billsmwaste.loading();
			parent.billsmwaste.importSuccess();
		}else {
			parent.billsmwaste.loading();
			if(msg != ''){
				parent.alert(msg,2);
...
<body>
	<div id="div_1">
		<form name="fileForm"  id="fileForm" method="post" action="../bill_sm_waste_dtl/importExcel" class="city-form" enctype="multipart/form-data">

 ...
 * 
 */
public class AccInventoryConDto  implements Serializable{
     ...
     * 所绑定的子容器资料list
     */
    private List<AccConInfoDto> accConInfoList;
	...
	public List<AccConInfoDto> getAccConInfoList() {
		return accConInfoList;
	}


	public void setAccConInfoList(List<AccConInfoDto> accConInfoList) {
		this.accConInfoList = accConInfoList;
	}


	public String getDestConNo() {
		return destConNo;
	}


	public void setDestConNo(String destConNo) {
		this.destConNo = destConNo;
	}
	...
	public String toString(){
		return " billNo:" + this.getBillNo() + " billType:" + this.getBillType()+ " direction:" + this.getDirection()
				+ " ConNo:" + this.getConNo()+ " cellNo:" + this.getCellNo() 
				+ " destConNo:" + this.getDestConNo()+ " destCellNo:" + this.getDestCellNo() 
				+ " MoveSkuQty:"+ this.getMoveSkuQty() + " MoveChildrenQty:"+ this.getMoveChildrenQty()
				+" accConInfoListSize:"+(this.getAccConInfoList()!=null? this.getAccConInfoList().size():0);
